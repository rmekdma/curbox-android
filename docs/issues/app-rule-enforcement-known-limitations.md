...
- **Evidence:**
  ...
  - [ForegroundEvidenceContractTest.kt](../../app/src/test/java/neth/iecal/curbox/domain/apprules/ForegroundEvidenceContractTest.kt)의 deterministic barrier. Formerly split source/revision calls are forced to pair as source `1` with revision `2` and source `2` with revision `1`; the atomic reservation keeps each source's pair together.
